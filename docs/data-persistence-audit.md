...
| Dado | Chave | Proteção |
| --- | --- | --- |
| Perfil e prescrição | identificador local compatível | armazenamento primário + espelho íntegro |
| Histórico | identificador local compatível | armazenamento primário + espelho íntegro |
| Medições | identificador local compatível | armazenamento primário + espelho íntegro |
| Check-ins | identificador local compatível | armazenamento primário + espelho íntegro |
...
- Backups podem ser restaurados na primeira tela após uma reinstalação ou em Ajustes. O arquivo é validado antes da confirmação, formatos antigos permanecem compatíveis e um snapshot automático permite reverter uma restauração interrompida.
